...
adminRoute.post('/brand',auth.isLogin,adminController.checkUniqueBrand,adminController.addBrand)
...
adminRoute.post('/editBrand',auth.isLogin,adminController.loadEditBrand)
